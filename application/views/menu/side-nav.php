<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?php echo base_url('dashboard'); ?>"><i class="fa fa-home"></i> Dashboard <span class="fa fa-chevron-right"></span></a>
                  </li>
                  <li><a href="<?php echo base_url('permintaan') ?>"><i class="fa fa-tasks"></i> Permintaan <span class="fa fa-chevron-right"></span></a>
                  </li>
                  <li><a href="<?php echo base_url('persediaan') ?>"><i class="fa fa-tasks"></i> Persediaan <span class="fa fa-chevron-right"></span></a>
                  ...
                  <!-- <li><a><i class="fa fa-tasks"></i> Data Prediksi <span class="fa fa-plus"></span></a>
                  ...
                  <li><a href="<?php echo base_url('user') ?>"><i class="fa fa-cogs"></i> User Settings <span class="fa fa-chevron-right"></span></a>
                    <!-- <ul class="nav child_menu">
