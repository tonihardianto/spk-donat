									...
									<div class="row">
										<div class="animated flipInY col-lg-3 col-md-3 col-sm-6  ">
											<div class="tile-stats">
												...
												<h3>Data User</h3>
												<p><a href="<?php echo base_url('user') ?>"><span class="badge badge-info"> More info <i class="fa fa-arrow-right"></i></span></a></p>
										...
										<div class="animated flipInY col-lg-3 col-md-3 col-sm-6  ">
											<div class="tile-stats">
												...
												<div class="count"><?php foreach($permintaan as $row): echo $row['permintaan']; endforeach ?></div>

												<h3>Permintaan</h3>
												<p><a href="<?php echo base_url('permintaan') ?>"><span class="badge badge-info"> More info <i class="fa fa-arrow-right"></i></span></a></p>
										...
										<div class="animated flipInY col-lg-3 col-md-3 col-sm-6  ">
											<div class="tile-stats">
												...
												<div class="count"><?php foreach($persediaan as $row): echo $row['total']; endforeach ?></div>

												<h3>Persediaan</h3>
												<p><a href="#"><span class="badge badge-info"> More info <i class="fa fa-arrow-right"></i></span></a></p>
										...
										<div class="animated flipInY col-lg-3 col-md-3 col-sm-6  ">
											<div class="tile-stats">
												...
												<div class="count"><?php foreach($produksi as $row): echo $row['total']; endforeach ?></div>

												<h3>Produksi</h3>
												<p><a href="<?php echo base_url('decision') ?>"><span class="badge badge-info"> More info <i class="fa fa-arrow-right"></i></span></a></p>
    					...
    					<form id="form-hitung" data-parsley-validate class="form-horizontal form-label-left">
    						...
    						<div class="item form-group">
    							...
    							<div class="col-md-8 col-sm-8 ">
    								<input type="text" id="tanggal_minta" name="tanggal_minta" class="form-control" placeholder="yyyy-mm-dd" autocomplete="off">
    							</div>
    						</div>

    						<div class="item form-group">
    							<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Permintaan <span
    									class="required">*</span>
    							</label>
    							<div class="col-md-8 col-sm-8 ">
    								<input type="number" name="permintaan" id="permintaan" required="required" class="form-control"
    									autocomplete="off">
    							</div>
    						</div>
    				...
    				<div class="x_content">
    					...
    					<form id="form-hitung" data-parsley-validate class="form-horizontal form-label-left">
    						<div class="item form-group">
    							...
    							<div class="col-md-8 col-sm-8 ">
    								<input type="text" id="tanggal_sedia" value="<?php echo date('Y-m-d'); ?>" name="tanggal_sedia" readonly class="form-control" placeholder="yyyy-mm-dd" autocomplete="off">
    							</div>
    						</div>

    						<div class="item form-group">
    							<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Persediaan <span
    									class="required">*</span>
    							</label>
    							<div class="col-md-8 col-sm-8 ">
    								<input type="number" name="persediaan" id="persediaan" placeholder="Masukkan sisa produksi hari ini" required="required" class="form-control"
    									autocomplete="off">
